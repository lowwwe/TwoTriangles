...
MyVector3::MyVector3(double t_x, double t_y, double t_z):
	x{ static_cast<float>(t_x) },
	y{ static_cast<float>(t_y) },
	z{ static_cast<float>(t_z) }
{
}
...
float MyVector3::dotProduct(const MyVector3 t_other) const
{
